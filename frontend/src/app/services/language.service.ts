...
export class LanguageService {
  ...
  private translations: Record<Locale, Record<string, string>> = {
    fr: {
      ...
      'footer.about_desc': 'Votre destination shopping n\'1 en Mauritanie. Nous sélectionnons avec soin les meilleurs articles pour vous offrir une expérience d\'achat premium et fiable.',
      'footer.how_to_order_title': 'Comment Commander ?',
      'footer.how_to_order_desc': 'C\'est simple ! Parcourez notre catalogue, ajoutez vos perles rares au panier, validez vos coordonnées de livraison et réglez en espèces seulement quand vous recevez votre colis.',
      'footer.symbols_title': 'Nos Symboles',
      'footer.symbols_desc_quality': 'Qualité certifiée : Produits rigoureusement sélectionnés.',
      'footer.symbols_desc_security': 'Sécurité 100% : Confidentialité totale de vos données.',
      'footer.symbols_desc_local': 'Fierté locale : Plateforme 100% Mauritanienne.',
    ...
    ar: {
      ...
      'footer.about_desc': 'وجهتكم الأولى للتسوق في موريتانيا. نختار بعناية أفضل المنتجات لنقدم لكم تجربة تسوق راقية وموثوقة.',
      'footer.how_to_order_title': 'كيفية الطلب؟',
      'footer.how_to_order_desc': 'الأمر بسيط! تصفح الكتالوج، أضف مشترياتك للسلة، أكد تفاصيل التوصيل وادفع نقداً فقط عند استلام طلبك.',
      'footer.symbols_title': 'رموزنا',
      'footer.symbols_desc_quality': 'جودة مضمونة: منتجات مختارة بدقة عالية.',
      'footer.symbols_desc_security': 'أمان 100%: سرية تامة لجميع بياناتكم.',
      'footer.symbols_desc_local': 'فخر محلي: منصة موريتانية 100%.',
